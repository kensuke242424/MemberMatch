...
struct Constants {
    ...
    // SF Symbols
    static let SF_chevron_backward: String = "chevron.backward"
    static let SF_chevron_up: String = "chevron.up"
    static let SF_chevron_down: String = "chevron.down"
    static let SF_pin: String = "pin"
    static let SF_pin_fill: String = "pin.fill"
